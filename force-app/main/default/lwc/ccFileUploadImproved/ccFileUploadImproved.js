...
import getExistingFileByName from '@salesforce/apex/CC_FileUploadImprovedHelper.getExistingFilesByName';
...
export default class FileUpload extends NavigationMixin(LightningElement) {
    ...
    connectedCallback(){
        ...
        if(cachedSelection){
            ...
            getExistingFileByName({recordId: this.recordId, fileName: this.overriddenFileName})
                .then((files) => {
