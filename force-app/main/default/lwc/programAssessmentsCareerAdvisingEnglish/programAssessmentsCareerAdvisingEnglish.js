...
import { OMNIDEF } from './programAssessmentsCareerAdvisingEnglish_def.js';
import tmpl from './programAssessmentsCareerAdvisingEnglish.html';
import tmpl_nds from './programAssessmentsCareerAdvisingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programAssessmentsCareerAdvisingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
