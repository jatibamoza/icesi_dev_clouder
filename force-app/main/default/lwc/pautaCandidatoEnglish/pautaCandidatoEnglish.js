...
import { OMNIDEF } from './pautaCandidatoEnglish_def.js';
import tmpl from './pautaCandidatoEnglish.html';
import tmpl_nds from './pautaCandidatoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pautaCandidatoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
