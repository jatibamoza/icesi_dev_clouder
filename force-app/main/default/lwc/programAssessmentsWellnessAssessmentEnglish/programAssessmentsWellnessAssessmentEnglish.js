...
import { OMNIDEF } from './programAssessmentsWellnessAssessmentEnglish_def.js';
import tmpl from './programAssessmentsWellnessAssessmentEnglish.html';
import tmpl_nds from './programAssessmentsWellnessAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programAssessmentsWellnessAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
