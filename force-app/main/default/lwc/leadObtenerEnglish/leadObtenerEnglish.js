...
import { OMNIDEF } from './leadObtenerEnglish_def.js';
import tmpl from './leadObtenerEnglish.html';
import tmpl_nds from './leadObtenerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class leadObtenerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
