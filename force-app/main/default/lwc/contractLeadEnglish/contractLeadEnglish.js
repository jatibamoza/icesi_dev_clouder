...
import { OMNIDEF } from './contractLeadEnglish_def.js';
import tmpl from './contractLeadEnglish.html';
import tmpl_nds from './contractLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
