...
import { OMNIDEF } from './leadColegioUpdateInfoUpdateEnglish_def.js';
import tmpl from './leadColegioUpdateInfoUpdateEnglish.html';
import tmpl_nds from './leadColegioUpdateInfoUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class leadColegioUpdateInfoUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
